...
?>
	...
	<div id="left-content">
		...
		<div id="superheader" style="z-index: 10">
		...
		<div id="content-container">
			...
			<!-- START CONTENT -->
			<div id="content">
				<div class="tabela_complexa">
				
				<div class="busca-na-pagina">
					<div class="busca-texto">BUSCAR NA LISTA: </div> <div id="search-inside-sc"></div>
				</div>
