				...
				<section id="woffice-login" class="<?php echo (!empty($login_revslider) ? 'revslider-enabled' : 'revslider-disabled'); ?>">
					...
					<div id="woffice-login-right">
						...
						<header>
							...
							<p style="text-align: center"><i class="fa fa-info-circle"></i> Ao realizar o login, você está aceitando os <a class="janela" href="<?php echo get_home_url() . '/termos-de-uso-btp-conecta';?>">Termos de Uso <i class="fa fa-external-link"></i></a></p>
